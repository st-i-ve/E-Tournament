...
const JoinTournamentModal = ({ isOpen, onClose, onJoinTournament }: JoinTournamentModalProps) => {
        ...
        <div className="space-y-4 max-h-96 overflow-y-auto">
          {filteredTournaments.length > 0 ? (
            filteredTournaments.map((tournament) => (
              <Card key={tournament.id} className="bg-gradient-to-br from-[#2C2C2E] to-[#1C1C1E] border-gray-700 hover:border-green-500/50 transition-all duration-300">
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1 text-gray-400">
                        ...
                        <span>{tournament.totalParticipants}/{tournament.maxParticipants} players</span>
                      </div>
                      <div className="flex items-center gap-1 text-gray-400">
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-white font-semibold mb-2">No tournaments found</h3>
