...
import { Upload, Camera, Award, Clock, AlertCircle, Check } from 'lucide-react';
...
const ResultSubmissionModal = ({ isOpen, onClose, matchData }: ResultSubmissionModalProps) => {
      ...
      case 'uploading':
        return (
          <div className="text-center py-6">
            ...
            <h3 className="text-base font-medium text-white mb-2">Processing...</h3>
      ...
      case 'success':
        return (
          <div className="text-center py-6">
            ...
            <p className="text-sm text-gray-400 mb-4">Waiting for verification</p>
      ...
      default:
        return (
          <>
            ...
            <div className="bg-gray-800/30 rounded-lg p-3 mb-4">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-white">{matchData.tournament}</span>
                </div>
            ...
            {/* Score Input */}
            <div className="mb-4">
              <h3 className="text-xs font-medium text-gray-400 mb-3">Match Result</h3>
              
              <div className="grid grid-cols-3 gap-3 items-center">
                <div>
                  <label className="block text-xs text-gray-500 mb-1">{matchData.homeTeam}</label>
                  <Counter
                    value={homeScore}
                ...
                <div>
                  <label className="block text-xs text-gray-500 mb-1">{matchData.awayTeam}</label>
                  <Counter
                    value={awayScore}
            ...
            <div className="mb-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <Badge variant="outline" className="text-xs bg-green-500/10 text-green-400 border-green-500/30 px-1.5 py-0">
                  Optional
                </Badge>
              </div>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-gray-900 border-gray-700 text-white max-w-sm p-4">
        <DialogHeader className="pb-2">
          <DialogTitle className="text-white text-base">Submit Result</DialogTitle>
