...
const SettingsPage = () => {
  ...
  const themeOptions = [
    { id: 'green', name: 'Emerald Green', color: 'bg-green-500', available: true },
    { id: 'forest', name: 'Forest Green', color: 'bg-green-700', available: true },
    { id: 'mint', name: 'Mint Green', color: 'bg-green-300', available: true },
    { id: 'blue', name: 'Ocean Blue', color: 'bg-blue-500', available: false, comingSoon: true },
    { id: 'purple', name: 'Royal Purple', color: 'bg-purple-500', available: false, comingSoon: true }
  ];
      ...
      <div className="p-4 space-y-6 relative z-10">
        ...
        <div className="animate-fade-in">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-sm font-medium text-white">Theme Selection</h2>
              <p className="text-xs text-gray-400">Customize your app appearance</p>
            </div>
          </div>
            ...
            {themeOptions.map((theme) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`w-4 h-4 rounded-full ${theme.color} ${!theme.available ? 'opacity-50' : ''}`} />
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-2">
              <div>
                ...
                <p className="text-xs text-gray-400">Get notified about match updates and results</p>
              </div>
              <Switch 
            ...
            <div className="flex items-center justify-between py-2">
              <div>
                <h3 className="text-sm font-medium text-white">Match Reminders</h3>
                <p className="text-xs text-gray-400">Remind me 30 minutes before matches start</p>
              </div>
              <Switch 
